                                    ...
                                    <td>
                                        ...
                                        @if($tran->approvalStatus != \App\Model\RequestStatus::Cancelled)
                                            @if($tran->approvalStatus != \App\Model\RequestStatus::Approved)
                                                <a class="btn btn-success btn-sm " href="/transaction/approve/{{ $tran->ref }}">Approve</a>
                                            @endif
                                            @if($tran->approvalStatus != -1)
                                                <a class="btn btn-danger btn-sm" href="/transaction/decline/{{ $tran->ref }}">Decline</a>
                                            @endif
                                        @endif
